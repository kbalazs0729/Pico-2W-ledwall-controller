...
void Routes::registerEndpoints(ApiServer& server) {
    server.add_endpoint("/", Method::GET, [](std::string_view) -> Response {
        ...
        static const char content[] =
            ...
            "           <li>/animation - POST: Select animation by integer id (0 = Rainbow, 1 = BadApple, 2 = Fire, 3 = Rain, 4 = Stars, 5 = Plasma, 6 = Fire2, 7 = RainFill, 8 = Tetris); an empty body resumes the current animation.</li>"
